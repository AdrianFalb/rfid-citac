...
void lcdReset(void)
{
	...
	HAL_GPIO_WritePin(GPIOB, DISPLAY_RESET_Pin, GPIO_PIN_RESET);
	HAL_Delay(100);
...
{
	HAL_GPIO_WritePin(GPIOB, DISPLAY_CD_Pin, GPIO_PIN_RESET);
	HAL_GPIO_WritePin(GPIOB, DISPLAY_CS_Pin, GPIO_PIN_RESET);

	HAL_SPI_Transmit(&hspi1, &address, 1, 250);
...
{
	HAL_GPIO_WritePin(GPIOB, DISPLAY_CD_Pin, GPIO_PIN_SET);
	HAL_GPIO_WritePin(GPIOB, DISPLAY_CS_Pin, GPIO_PIN_RESET);

	HAL_SPI_Transmit(&hspi1, &parameter, 1, 250);
...
void lcdWriteData(uint8_t dataByte1, uint8_t dataByte2)
{
	...
	HAL_SPI_Transmit(&hspi1, &dataByte1, 1, 250);
	//readWriteSPI1(dataByte2);
	HAL_SPI_Transmit(&hspi1, &dataByte2, 1, 250);
